...
import { Card, Icon, AnimatedCounter, SkeletonRow } from '@/components'
...
const RestoreAudit = () => {
    ...
    <div className="ra-form-section">
      ...
      <div className="ra-btn-row">
        ...
        <button className="ra-btn ra-btn-primary" onClick={handleCreateEvent} disabled={loading}>
          {loading ? <span>Guardando...</span> : <span>Siguiente <Icon name="arrowRight" className="ml-2 inline-block" />: Validaciones Técnicas</span>}
        </button>
      </div>
    </div>
  )
  ...
  const renderStep1 = () => (
    <div className="ra-form-section">
      ...
      <div className="ra-btn-row">
        <button className="ra-btn ra-btn-secondary" onClick={() => setWizardStep(0)}><span><Icon name="arrowLeft" className="mr-2 inline-block" /> Anterior</span></button>
        <button className="ra-btn ra-btn-primary" onClick={handleSaveTechnical} disabled={loading}>
          {loading ? <span>Guardando...</span> : <span>Siguiente <Icon name="arrowRight" className="mr-2 inline-block" />: Validaciones Funcionales</span>}
        </button>
      </div>
    </div>
  )
      ...
      <div className="ra-form-section">
        ...
        <div className="ra-btn-row">
          ...
          <button className="ra-btn ra-btn-primary" onClick={handleSaveFunctional} disabled={loading}>
            {loading ? <span>Guardando...</span> : <span>Siguiente <Icon name="arrowRight" className="ml-2 inline-block" />: Impacto Operativo</span>}
          </button>
        </div>
      </div>
    )
    ...
    <div className="ra-form-section">
      ...
      <div className="ra-btn-row">
        ...
        <button className="ra-btn ra-btn-primary" onClick={handleSaveImpact} disabled={loading}>
          {loading ? <span>Guardando...</span> : <span>Siguiente <Icon name="arrowRight" className="ml-2 inline-block" />: Confirmación</span>}
        </button>
      </div>
    </div>
  )
    ...
    <div className="ra-form-section">
      ...
      <div className="ra-btn-row" style={{ marginTop: '1.5rem' }}>
        ...
        <button className="ra-btn ra-btn-success" onClick={handleConfirm} disabled={loading || !formData.accepts_responsibility}>
          {loading ? <span>Confirmando...</span> : <span><Icon name="lock" className="mr-2 inline-block" /> Confirmar y Bloquear Registro</span>}
        </button>
      </div>
    </div>
  )
      ...
      <div className="ra-detail-sections">
        ...
        {tc && (
          <div className="ra-detail-section">
            <h3><Icon name="settings" className="mr-2 inline-block" /> Validaciones Técnicas</h3>
            <div className="ra-detail-grid">
              <div className="ra-detail-item"><span className="label">Integridad Verificada</span><span className="value">{tc.integrity_verified ? <><Icon name="checkCircle" size={14} className="mr-1" /> Sí</> : <><Icon name="xCircle" size={14} className="mr-1" /> No</>}</span></div>
              ...
              <div className="ra-detail-item"><span className="label">Consistencia Validada</span><span className="value">{tc.data_consistency_validated ? <><Icon name="checkCircle" size={14} className="mr-1" /> Sí</> : <><Icon name="xCircle" size={14} className="mr-1" /> No</>}</span></div>
              <div className="ra-detail-item"><span className="label">Checksum</span><span className="value">{tc.checksum_match === null ? 'N/A' : tc.checksum_match ? <><Icon name="checkCircle" size={14} className="mr-1" /> Coincide</> : <><Icon name="xCircle" size={14} className="mr-1" /> No coincide</>}</span></div>
        ...
        {oi && (
          <div className="ra-detail-section">
            <h3><Icon name="alertTriangle" className="mr-2 inline-block" /> Impacto Operativo</h3>
            <div className="ra-detail-grid">
              <div className="ra-detail-item"><span className="label">Downtime</span><span className="value">{oi.had_downtime ? <><Icon name="checkCircle" size={14} className="mr-1" /> Sí — {oi.downtime_minutes} min</> : <><Icon name="xCircle" size={14} className="mr-1" /> No</>}</span></div>
              ...
              <div className="ra-detail-item"><span className="label">Reintento</span><span className="value">{oi.needed_retry ? <><Icon name="checkCircle" size={14} className="mr-1" /> Sí</> : <><Icon name="xCircle" size={14} className="mr-1" /> No</>}</span></div>
              <div className="ra-detail-item"><span className="label">Rollback</span><span className="value">{oi.needed_rollback ? <><Icon name="checkCircle" size={14} className="mr-1" /> Sí</> : <><Icon name="xCircle" size={14} className="mr-1" /> No</>}</span></div>
        ...
        {confirmation && (
          <div className="ra-detail-section" style={{ borderColor: 'rgba(34,197,94,0.3)' }}>
            ...
            <div className="ra-detail-grid">
              ...
              <div className="ra-detail-item"><span className="label">Acepta Responsabilidad</span><span className="value">{confirmation.accepts_responsibility ? <><Icon name="checkCircle" size={14} className="mr-1" /> Sí</> : <><Icon name="xCircle" size={14} className="mr-1" /> No</>}</span></div>
    ...
    return (
      <div>
        <div className="ra-stats-grid">
          ...
          <div className="ra-stat-card"><div className="stat-icon"><Icon name="alertTriangle" size={28} className="text-red-500" /></div><div className="stat-value"><AnimatedCounter value={stats.critical_impact_rate_percent} />%</div><div className="stat-label">Tasa Impacto Crítico</div></div>
        </div>
  ...
  return (
    <div className="restore-audit-page">
      <div className="page-header">
        <div>
          <h1>Auditoría de Restauraciones</h1>
          ...
          {showSkeleton ? (
            ...
            <div className="ra-table-wrap">
              <table className="ra-table">
                ...
                <tbody>
                  {events.map(ev => (
                    <tr key={ev.id} onClick={() => { fetchEventDetail(ev.id); setActiveTab('detail') }} className="ra-table-row">
